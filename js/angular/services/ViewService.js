...
//var view = chrome.extension.getURL("/img/view.png");
...
var database = chrome.extension.getURL("/img/icons/database.png");
...
var faq = '<b>1. What is Admin Simplified?</b><br/>'+
'Admin Simplified is chrome extension by installing it, it enables you to see your recently created/modified components.<br/><br/>'+
'<b>2. Why should i use Admin Simplified?</b><br/>'+
'Admin Simplified is time saver machine, which will help you find your components by avoiding unnecessary clicks.<br/><br/>'+
'<b>3. Will it work on multiple org simultaneously?</b><br/>'+
'Yes! You can use this tool for multiple org simultaneously.<br/><br/>'+
'<b>4. Admin Simplified is unable to show my data, What should i do?</b><br/>'+
...
'   <tr><td colspan="2"><h3>Admin Simplified</h3></td></tr>'+
'   <tr><td colspan="2"><a href="https://github.com/rajnikantroy/AdminSimplified" target="_blank" title="See how you can use Admin Simplified.">How to use</a></td></tr>'+
'   <tr><td colspan="2"><a href="https://github.com/rajnikantroy/AdminSimplified/issues/new" target="_blank" title="If you getting any issue, please report on github." >Report Issue</a></td></tr>'+
'   <tr><td colspan="2"><a href="mailto:rajkant020@gmail.com?subject=Feedback/Suggestions of Admin Simplified" title="If you have any feedback/suggestions, please mailto rajkant020@gmail.com." target="_blank">Feedback and Suggestions</a></td></tr>'+
...
this.functionalitiesMenu = '<table class="mainmenuTable"><tr ng-switch on="menu.value" ng-if="menu.formainmenu" ng-click="detailsPopupOpen(menu)" ng-repeat="menu in favouriteMenu | filter:searchMenu">'+
'<td Class="tooltip-me" data-title="{{menu.label}}">'+
'<img ng-switch-when="ChangeUser" class="menuicon" src="'+viewas+'"/>'+
'<img ng-switch-when="RecentlyViewed" class="menuicon" src="'+recentitems+'"/>'+
'<img ng-switch-when="Campaign" class="menuicon" src="'+debuglogs+'"/>'+
'<img ng-switch-when="Lead" class="menuicon" src="'+pages+'"/>'+
'<img ng-switch-when="Account" class="menuicon" src="'+staticresources+'"/>'+
'<img ng-switch-when="Contact" class="menuicon" src="'+database+'"/>'+
'<img ng-switch-when="Opportunity" class="menuicon" src="'+workflows+'"/>'+
'<img ng-switch-when="Quote" class="menuicon" src="'+classes+'"/>'+
'<img ng-switch-when="Contract" class="menuicon" src="'+objects+'"/>'+
'<img ng-switch-when="Order" class="menuicon" src="'+triggers+'"/>'+
//'<img ng-switch-when="Fields" class="menuicon" src="'+fields+'"/>'+
'<img ng-switch-when="Order" class="menuicon" src="'+AuraDefinitionBundles+'"/>'+
'<img ng-switch-when="Order" class="menuicon" src="'+labels+'"/>'+
//'<img ng-switch-when="StaticResource" class="menuicon" src="'+staticresources+'"/>'+
//'<img ng-switch-when="Components" class="menuicon" src="'+components+'"/>'+
//'<img ng-switch-when="Workflows" class="menuicon" src="'+workflows+'"/>'+
//'<img ng-switch-when="Flows" class="menuicon" src="'+flows+'"/>'+
...
'   <td class="action" ng-show="r.LogLength || r.Name || r.email || r.DeveloperName || r.Type || r.CaseNumber || r.ContractNumber || r.OrderNumber" ng-repeat="faction in selectedMetadata.fieldlevelactions">'+
...
'   <td class="action" ng-show="r.LogLength || r.Name || r.DeveloperName || r.CaseNumber || r.ContractNumber || r.OrderNumber" ng-repeat="faction in selectedMetadata.fieldlevelactions">'+
'       <a ng-if="faction.name == view" target="_blank" href="{{baseUrl}}/{{faction.actionUrl}}{{r.Id}}">{{faction.name}}</a>'+
...
'<tr><th><input placeholder="Quick Find" type="text" ng-model="searchMetadataMenu" /></th></tr>'+
...
'</header>'+
  ...
  '<table width="100%"><tr>'+
  '<td class="bold"><a target="_blank" href="https://chrome.google.com/webstore/detail/vlocity-simplified/pbhnnodnianlmlnioebcoaijdeihnimd?hl=en">Rate Us on chrome</a></td>'+
  '<td class="bold"><a target="_blank" href="https://fb.com/salesforcesimplified">Facebook Page</a></td>'+
  '<td class="bold"><a target="_blank" href="https://github.com/rajnikantroy/AdminSimplified/issues">Report Issue</a></td>'+
  '<td class="bold"><a target="_blank" href="https://www.linkedin.com/in/rajnikantroy/">linkedin</a></td>'+
'</tr></table>'+
'</footer>'+
'</div>'+
'</div>'+
...
//'<span class="salesforcesimplifiedTitle">Admin Simplified (We are open source now)</span>'+
//'</div>'+
